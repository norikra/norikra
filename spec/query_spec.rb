  ...
  context 'when instanciate' do
    describe '#initialize' do
      ...
      context 'with typedef as hash' do
        subject { Norikra::Query.new(:tablename => 'TestTable', :typedef => definition, :expression => expression) }
      ...
      context 'with typedef as instance of Norikra::Typedef' do
        subject { Norikra::Query.new(:tablename => 'TestTable', :typedef => typedef, :expression => expression) }
